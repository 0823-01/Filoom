...
--영화 이미지
INSERT INTO "FILOOM"."POSTER" (IMAGE_ID, MOVIE_NO, FILE_NAME, FILE_CODENAME, IMAGE_PATH, UPLOAD_DATE, FILE_LEVEL, STATUS) VALUES ('1', '1', 'ORIGINFILENAME', 'joker.jpg', 'resources/images/posters/joker.jpg', TO_DATE('2024-12-11 18:14:15', 'YYYY-MM-DD HH24:MI:SS'), '1', 'Y');
...
INSERT INTO "FILOOM"."COUPON" (COUPON_NO, COUPON_NAME, COUPON_STATUS, COUPON_LEVEL) VALUES ('902', '이벤트쿠폰',  'Y', '1');
INSERT INTO "FILOOM"."COUPON" (COUPON_NO, COUPON_NAME, COUPON_STATUS, COUPON_LEVEL) VALUES ('903', '댓글쿠폰',  'Y', '1');
INSERT INTO "FILOOM"."COUPON" (COUPON_NO, COUPON_NAME, COUPON_STATUS, COUPON_LEVEL) VALUES ('904', '쿠폰',  'Y', '1');
INSERT INTO "FILOOM"."COUPON" (COUPON_NO, COUPON_NAME, COUPON_STATUS, COUPON_LEVEL) VALUES ('905', '이벤트1쿠폰',  'Y', '1');
INSERT INTO "FILOOM"."COUPON" (COUPON_NO, COUPON_NAME, COUPON_STATUS, COUPON_LEVEL) VALUES ('906', '이벤트2쿠폰',  'Y', '1');
...
COMMIT;
		...
		SELECT MOVIE_NO, MOVIE_TITLE, DIRECTOR, GENRE, RUNTIME, FILM_RATE, FILE_CODENAME, IMAGE_PATH, PLAYING_NO, TO_CHAR(PLAYTIME, 'YYYY.MM.DD HH24:MI') AS PLAYTIME,SCREEN_NAME, SCREEN_INFO
		  FROM MOVIE M 
